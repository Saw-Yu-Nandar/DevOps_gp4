...
public class PeoplePopulation {
    ...
    private String capCitName;
    private String capCitCountry;
    private String capCitPopulation;
    private String capCitContinent;
    private String capCitRegion;
    ...
    public String getCapCitName() {
        return capCitName;
    }

    public void setCapCitName(String capCitName) {
        this.capCitName = capCitName;
    }

    public String getCapCitCountry() {
        return capCitCountry;
    }

    public void setCapCitCountry(String capCitCountry) {
        this.capCitCountry = capCitCountry;
    }

    public String getCapCitPopulation() {
        return capCitPopulation;
    }

    public void setCapCitPopulation(String capCitPopulation) {
        this.capCitPopulation = capCitPopulation;
    }

    public String getCapCitContinent() {
        return capCitContinent;
    }

    public void setCapCitContinent(String capCitContinent) {
        this.capCitContinent = capCitContinent;
    }

    public String getCapCitRegion() {
        return capCitRegion;
    }

    public void setCapCitRegion(String capCitRegion) {
        this.capCitRegion = capCitRegion;
    }
